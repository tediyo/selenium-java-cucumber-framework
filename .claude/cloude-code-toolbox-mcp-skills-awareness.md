...
_Generated: 2026-04-09T14:34:32.810Z_
...
Workspace `mcp.json` _(folder: TestFM)_

- **c:\Users\Thedr\Desktop\TestFM\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Thedr\AppData\Roaming\Code\User\mcp.json** — _File missing_
